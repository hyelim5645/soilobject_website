...
import { Reveal, RevealItem, RevealGrid } from "@/components/ui/reveal";
...
export async function ObjectCollection() {
  ...
  return (
    <section id="objects" className="py-24">
      <Container>
        <Reveal>
          <RevealItem className="flex items-end justify-between gap-4">
            <SectionHeading
              number="01"
          ...
          <RevealGrid className="mt-12 grid grid-cols-2 gap-x-6 gap-y-10 md:grid-cols-4">
